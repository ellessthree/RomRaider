...
public final class MediumGaugeStyle extends PlainGaugeStyle {
    public MediumGaugeStyle(LoggerData loggerData) {
        super(loggerData);
    }
    ...
    protected void doApply(JPanel panel) {
        ...
        liveValueLabel.setFont(panel.getFont().deriveFont(PLAIN, 32F));
        liveValueLabel.setForeground(WHITE);
        liveValuePanel.setBackground(LIGHT_GREY);
        liveValuePanel.setPreferredSize(new Dimension(110, 70));
        ...
        progressBar.setPreferredSize(new Dimension(17, 70));
    ...
    private JPanel buildMaxMinPanel(String title, JLabel label) {
        ...
        label.setFont(panel.getFont().deriveFont(PLAIN, 11F));
        label.setForeground(WHITE);
        panel.setPreferredSize(new Dimension(54, 33));
        panel.setBackground(LIGHT_GREY);
        JLabel titleLabel = new JLabel(title, JLabel.CENTER);
        titleLabel.setFont(panel.getFont().deriveFont(PLAIN, 11F));
